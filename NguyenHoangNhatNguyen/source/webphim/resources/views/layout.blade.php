...
<html lang="vi">
   <head>
      ...
      <title>Web phim siêu lậu của Luchan</title>
   ...
   <body class="home blog halimthemes halimmovies" data-masonry="">
         ...
         <div class="container footer-columns">
            <div class="row container">
               <div class="widget about col-xs-12 col-sm-4 col-md-4">
                  ...
                  Liên hệ QC: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e5958d8c888d849ccb868aa58288848c89cb868a88">[nguyen.nhn.61cntt@gmail.com]</a>
                </div>
            </div>
         </div>
      </footer>
      ...
      <div id="fb-root"></div>
      <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v16.0" nonce="qPBxfGJC"></script>
                    ...
                    $.getJSON('/json/movies.json',function(data){
                        $.each(data,function(key,value){
                            if(value.title.search(expression)!=-1){
                                ...
                                //$('#result').append('<li class="list-group-item" style="cursor:pointer"><img height="50" width="50" src="/uploads/movie/'+value.image+'"> '+value.title+'</br> | <span>'+value.description+'</span></li>');
                            }
                        });
                    })
                }else{
