                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('adminshop.post.category.index') }}">Loại bài
                                    viết</a></li>
                    ...
                    <form action="" method="post">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="exampleInputProduct_Name1">Tên loại bài viết</label>
                                <input type="text" name="name" class="form-control" id="exampleInputProduct_Name1"
