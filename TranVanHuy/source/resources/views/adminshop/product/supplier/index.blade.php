    ...
    <section class="content">
      <div class="card">
        <div class="card-header">
          <a href="{{ route('adminshop.supplier.create') }}">
        ...
        <div class="card-body">
            <table class="table table-bordered">
                <thead>
                  <tr>
                    <th style="width: auto">Tên nhà cung cấp</th>
                ...
                <tbody>
                  @if (count($supplier))
                    @foreach ($supplier as $item)
                      <tr>
                        ...
                        <td>
                          <div class="btn-group">
                            <abbr title="Sửa">
                              <a href="{{ route('adminshop.supplier.edit', $item['id'])}}" class="mr-1">
                            ...
                            <abbr title="Xóa">
                              <a onclick="return confirm('Bạn có muốn xóa nhà cung cấp này không ?')" href="{{ route('adminshop.supplier.delete', $item['id'])}}">
                    ...
                    @endforeach
                  @else
                      <td colspan="2">Không có nhà cung cấp</td>
                  @endif
                </tbody>
              </table>
            <hr>
